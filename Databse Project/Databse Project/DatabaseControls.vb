...
"CREATE TABLE BankTransaction (
    ...
    ''' <param name="fieldToReturn"></param>
    ''' <returns></returns>
    Public Function FindValueInTable(tableName As String, fieldName As String, valueToFind As Object, fieldToReturn As String) As Integer
        ...
        If databaseLoaded Then
            ...
            Try
                ...
                For Each row In rows
                    ...
                    If row.Field(Of String)(fieldName) = CStr(valueToFind) Then
                        Return row.Field(Of Integer)(fieldToReturn)
                    End If
